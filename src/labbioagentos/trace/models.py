...
class TraceEventType(StrEnum):
    ...
    SKILL_CONTEXT_ACCESSED = "SKILL_CONTEXT_ACCESSED"
    ...
    CAPABILITY_PHASE_STARTED = "CAPABILITY_PHASE_STARTED"
    CAPABILITY_PHASE_COMPLETED = "CAPABILITY_PHASE_COMPLETED"
    CAPABILITY_PHASE_FAILED = "CAPABILITY_PHASE_FAILED"
    FINALIZATION_PHASE_STARTED = "FINALIZATION_PHASE_STARTED"
    FINALIZATION_PHASE_COMPLETED = "FINALIZATION_PHASE_COMPLETED"
    FINALIZATION_PHASE_FAILED = "FINALIZATION_PHASE_FAILED"
